...
async function loadFiles() {
    try {
        ...
        const crimes = [
            '„Teška tjelesna povreda“| nakon kraćeg verbalnog sukoba u alkoholisanom stanju pretukao oca i porodičnog prijatelja na njihovom imanju u mjestu ###NEW_RANDOM_MJESTO###. Osumnjičeni je u fizičkom obračunu koristio i dio konjske opreme za vuču, zvani vagir.',
            '„Teška tjelesna povreda“| napao komšiju jer je prošao traktorom kroz njegovu njivu. Osumnjičeni je u fizičkom obračunu koristio i veliku posudu u kojoj se drži rakija, zvanu pletenka.',
            '„Ugrožavanje sigurnosti“| nakon proslave pobjede FK Glasinac protiv FK Vlasenica pucao kroz prozor svog automobila i uzvikivao "Kosovo je srce Srbije" i "Dogodine u Prizrenu". Osumnjičeni je istoga dana primjećen kako izlazi iz kontejnera za otpad, u kom je najvjerovatnije preskpavao neko vrijeme usled alkoholisanosti.',
            '„Ugrožavanje sigurnosti“| prilikom rutinske kontrole saobraćaja fizički napao mlađeg policijskog službenika. Osumnjičeni je nakon obavljenog informativnog razgovora pušten iz pritvora, da bi kratko nakon puštanja iz PU Sokolac na društvenu mrežu Fejsbuk objavio uvredljiv status o pripadnicima policije, te je brzo nakon toga opet priveden.',
            ...
            '„Teška tjelesna povreda“| prilikom otvaranja novog regionalnog puta pokušao fizički napasti nekoliko stranačkih funkcionera. U pomenutom obračunu lakše tjelesne povrede zadobio je i lokalni sveštenik, koga je osumnjičeni napao, dok je lice N.N. (nastanjeno u FBiH) pokušavalo da odbrani sveštenika.',
